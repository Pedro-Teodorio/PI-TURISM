        ...
        <ul class="sidebar-nav">
          ...
          <li class="sidebar-item mb-2">
            ...
            >
              ...
              <li class="sidebar-item">
                <a href="../cadastro_categoria/index.php" class="sidebar-link">Categoria</a>
              </li>
            </ul>
          </li>
          <li class="sidebar-item">
              ...
              >
                <div class="col-1 me-5">
                  <p class="card-text mb-0">
                    <i
                      class="lni lni-checkmark bg-color-logo text-light p-2 rounded-circle fs-3"
                    ></i>
                  </p>
                </div>
                <div class="col">
            ...
            <div class="card rounded-3">
              ...
              >
                <div class="col-1 me-5">
                  <p class="card-text">
                    <i
                      class="lni lni-archive bg-color-logo text-light p-2 rounded-circle fs-3"
                    ></i>
                  </p>
                </div>
                <div class="col">
            ...
            <div class="card rounded-3">
              ...
              >
                <div class="col-1 me-5">
                  <p class="card-text">
                    <i
                      class="lni lni-notepad bg-color-logo text-light p-2 rounded-circle fs-3"
                    ></i>
                  </p>
                </div>
                <div class="col">
            ...
            <div class="card rounded-3">
              ...
              >
                <div class="col-1 me-5">
                  <p class="card-text">
                    <i
                      class="lni lni-users bg-color-logo text-light p-2 rounded-circle fs-2"
                    ></i>
                  </p>
                </div>
                <div class="col">
